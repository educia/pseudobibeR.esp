...
parse_biber_features <- function(tokens, measure, normalize,
  ...
  # REVISION HERNAN (Fases 2-3): f_31/f_32 (quien/el cual) y f_15 (infinitivo
  # nominal-sujeto) salen de la lista siempre-cero; ahora los poblan sus bloques.
  surface_only_zero <- c(
    "f_09_pronoun_it", "f_12_proverb_do",
    "f_28_present_participle_whiz",
    "f_59_contractions", "f_60_that_deletion",
    "f_61_stranded_preposition", "f_62_split_infinitive"
  )
