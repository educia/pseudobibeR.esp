...
#
# Helper UDPipe para los tests en español. Apunta al modelo spanish-gsd.
# Espejo estructural de helper-udpipe-fr.R (francés). Cada idioma tiene su
# helper para que las suites no interfieran.

udpipe_model_filename <- "spanish-gsd-ud-2.5-191206.udpipe"
